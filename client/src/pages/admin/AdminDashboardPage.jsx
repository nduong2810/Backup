...
export default function AdminDashboardPage() {
      ...
      <svg className="w-full" viewBox={`0 0 ${w} ${h}`} preserveAspectRatio="xMidYMid meet">
        ...
        {hoveredIndex !== null && (
          <g pointerEvents="none">
            ...
            />
            <text
              x={Math.max(pad.left + 65, Math.min(w - pad.right - 65, getX(hoveredIndex)))}
              y={pad.top - 15}
              textAnchor="middle"
            ...
            <text
              ...
              y={pad.top - 2}
              textAnchor="middle"
              className="text-[9px] fill-slate-300 font-semibold"
            >
        ...
        {timeline.map((d, i) => {
          ...
          return (
            <rect
              key={i}
              x={i === 0 ? pad.left : xStart}
              y={pad.top}
              width={i === 0 || i === timeline.length - 1 ? colW / 2 : colW}
              height={innerH}
              fill="transparent"
  ...
  return (
    <div className="mx-auto w-full max-w-[1440px] px-6 lg:px-10 pt-2 pb-8">
        ...
        <aside className="w-full md:w-56 shrink-0">
          ...
          <div className="px-0.5 mb-4">
            <div className="flex items-center gap-2">
              ...
              <h1 className="text-lg font-bold text-slate-900">Trang quản trị</h1>
            </div>
          ...
          <button
            ...
            className="md:hidden flex items-center justify-between w-full rounded-lg border border-slate-200 bg-white px-3 py-2 text-xs font-medium text-slate-700 shadow-sm mb-2"
          >
            ...
            <span className="material-symbols-outlined text-sm transition-transform" style={{ transform: sidebarOpen ? 'rotate(180deg)' : '' }}>
              expand_more
            </span>
          </button>

          {/* Tab list dọc */}
          <nav className={`space-y-1.5 ${sidebarOpen ? 'block' : 'hidden'} md:block`}>
            {TABS.map((tab) => {
              ...
              return (
                <button
                  ...
                  className={`w-full flex items-center gap-3 rounded-2xl px-4 py-3 text-left text-base font-semibold transition-all ${
                    isActive
                ...
                >
                  ...
                  {badge > 0 && (
                    <span className={`px-2 py-0.5 text-xs rounded-full font-bold leading-none ${
                      isActive
          ...
          {/* Separator */}
          <div className="hidden md:block border-t border-slate-100 mt-5 pt-5 px-0.5">
            <p className="text-xs text-slate-400 font-semibold uppercase tracking-wider">Lối tắt</p>
            <a
              href="/"
              className="flex items-center gap-2.5 mt-3 text-sm text-slate-500 hover:text-primary transition-colors font-medium"
            >
            ...
            <a
              href="/admin/profile"
              className="flex items-center gap-2.5 mt-2.5 text-sm text-slate-500 hover:text-primary transition-colors font-medium"
            >
              ...
              {loading ? (
                ...
                <>
                      ...
                      <div className="flex items-center justify-between mb-4">
                        ...
                        <div className="flex items-center gap-3 text-xs font-semibold">
                          <span className="flex items-center gap-1">
                            <span className="w-2.5 h-2.5 bg-primary rounded-full" /> User mới
                          </span>
                          <span className="flex items-center gap-1">
                            <span className="w-2.5 h-2.5 bg-emerald-500 rounded-full" /> Bài đăng
                          </span>
                        </div>
                      </div>
                  ...
                  <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                    ...
                    {/* Post Response Rate Distribution */}
                    <div className="rounded-2xl border border-slate-200 bg-white p-6 shadow-sm">
