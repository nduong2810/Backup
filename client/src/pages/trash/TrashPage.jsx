...
export default function TrashPage() {
  ...
  return (
    <div className="mx-auto flex-1 min-w-0 max-w-4xl pb-12 px-4">
      {/* Header */}
      <div className="mb-6 flex flex-col gap-2 border-b border-slate-100 pb-4">
        <h1 className="text-2xl font-extrabold text-slate-800 flex items-center gap-2">
          <span className="material-symbols-outlined text-2xl text-rose-500">delete</span>
          Thùng rác
        </h1>
        <p className="text-sm text-slate-500">
          Danh sách các bài viết bạn đã xóa trong vòng 7 ngày qua.
        </p>
      </div>

      {/* Info Warning Box */}
      <div className="mb-6 flex items-start gap-3 rounded-2xl border border-amber-200 bg-amber-50/70 p-4 text-amber-900 shadow-sm">
