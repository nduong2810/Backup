  ...
  return (
    <section className="mt-8">
      ...
      {comments && comments.length > 0 ? (
        <div className="flex flex-col gap-4 bg-white/90 rounded-2xl border border-slate-200 p-4 sm:p-6 shadow-sm">
        ...
        <div className="text-center py-8 text-slate-400 bg-white/80 rounded-2xl border border-slate-200">
